 ...
 */
export type AssetCode = 'ACCRUED_INCOME' | 'APPROPRIATIONS' | 'ASSETS' | 'BONDS' | 'CAPITAL_RESERVERS' | 'CAPITAL_RESERVERS_AND_LIABILITIES' | 'CASH' | 'CASH_AT_BANK' | 'CASH_AT_CRYPTO_BROKER' | 'CASH_AT_P2P' | 'CASH_AT_STOCK_BROKER' | 'CASH_IN_HAND' | 'CONVERTIBLE_BONDS' | 'CREDITORS' | 'CURRENT_ASSETS' | 'CURRENT_CRYPTOCURRENCIES' | 'CURRENT_DEBTORS' | 'CURRENT_INVESTMENTS' | 'CURRENT_PRIVATE_STOCK_SHARES' | 'CURRENT_PUBLIC_STOCK_SHARES' | 'CURRENT_STOCKS' | 'EURO_AREA_SALES_RECEIVABLES' | 'EU_SALES_RECEIVABLES' | 'FINLAND_SALES_RECEIVABLES' | 'GROUP_UNDERTAKINGS_HOLDINGS' | 'INTANGLIBLE_ASSETS' | 'INVESTMENTS' | 'LIABILITITES_TO_CREDIT_INSTITUTIONS' | 'LOANS_RECEIVABLE' | 'NON_CURRENT_ASSETS' | 'OTHER_CREDITORS' | 'OTHER_DEBTORS' | 'OTHER_INVESTMENTS' | 'OTHER_SHARES' | 'OWNED_BY_GROUP' | 'OWNED_BY_PARTICIPATING' | 'P2P_LOANS_RECEIVABLE' | 'PROVISIONS' | 'SHORT_SELLING_STOCKS' | 'STOCK_BROKER_LOANS' | 'SUBSCRIBED_CAPITAL' | 'SUBSRIBED_CAPITAL_UNPAID' | 'TANGLIBLE_ASSETS' | 'TRADE_DEBTORS';
